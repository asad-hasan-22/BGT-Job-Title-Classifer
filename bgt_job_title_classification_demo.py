...
# Load vectorizor
loaded_vectorizer = pickle.load(open('bgtocc_classifier_count_vectorizer.pkl', 'rb'))
...
st.title('BGT Job Title Classifier')
...
if option == 'Naive Bayes':
    filename = '20211209_bgtocc_naive_bayes_job_title_classifier.pkl'
elif option == 'Support Vector Machine (SVM)':
    filename = '20211209_bgtocc_linear_svc_job_title_classifier.pkl'
